...
from incr_modules.delayedevflownet_incr import DelayedEVFlowNetIncr
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--trained_model", 
        default="./ev_projs/SysSSLE2VID/trained_models/model_03082022_232538_8543a87e22924a718621d5b9f9699431/DelayedEVFlowNet.pt", 
        help="model to be evaluated"
    )

    parser.add_argument(
        "--config",
        default="./ev_projs/SysSSLE2VID/configs/eval_flow_delayed_evflow.yml",
